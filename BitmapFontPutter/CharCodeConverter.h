...
class CharCodeConverter
{
    ...
    private:
        CodeData* s_HashTableToSJIS[MAX_HASH_TABLE];
        CodeData s_DataToSJIS[CODE_TABLE_SIZE];
        CodeData* s_HashTableToUTF16[MAX_HASH_TABLE];
        CodeData s_DataToUTF16[CODE_TABLE_SIZE];
};
